 ...
 * @author Aluno
 */
@WebServlet(name = "CarregarTipoEvento", urlPatterns = {"/CarregarTipoEvento"})
public class CarregarTipoEvento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("tipoEvento", dao.carregar(idTipoEvento));
        } catch (Exception ex) {
